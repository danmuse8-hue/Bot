...
# ─── SYSTEM PROMPT ───────────────────────────────────────────────────────────
SYSTEM_PROMPT = """
You are an expert BetPawa virtual football analyst and predictor covering three leagues.
...
── EREDIVISIE TIER TABLE ───────────────
Ajax            ATK:H  DEF:S
PSV Eindhoven   ATK:H  DEF:S
Feyenoord       ATK:H  DEF:A
AZ Alkmaar      ATK:H  DEF:A
Twente          ATK:M  DEF:S
Utrecht         ATK:M  DEF:A
Vitesse         ATK:M  DEF:W
Heerenveen      ATK:M  DEF:W
Groningen       ATK:M  DEF:W
NEC Nijmegen    ATK:M  DEF:A
Sparta Rotterdam ATK:M DEF:A
Go Ahead Eagles ATK:L  DEF:W
Almere City     ATK:L  DEF:W
Excelsior       ATK:L  DEF:W
RKC Waalwijk    ATK:L  DEF:W
Volendam        ATK:L  DEF:W
Fortuna Sittard ATK:L  DEF:W
PEC Zwolle      ATK:L  DEF:A
